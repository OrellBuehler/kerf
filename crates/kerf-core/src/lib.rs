...
pub use engine::{
    ...
    proxy_width, render_variants, render_with, render_with_progress, set_speech_model, speech_model_names, stitch_insta360, stitched_path,
    stream_preview, validate_export, Container, DownloadProgress, ExportOptions, ExportProgress, ExportVariant, Fit, ImageFormat,
    PreviewFrame, RateControl, Region, RenderStatus, SpeechModelInfo, VariantProgress, DEFAULT_SPEECH_MODEL,
};
...
pub use model::{
    ...
    DiffKind, EditSource, Framing, Keyframe, Marker, Mask, MaskShape, Projection, Reframe, ReframeKeyframe, ResolvedReframe, Revision,
