...
impl KerfMcp {
    ...
    #[tool(description = "Get an asset's probed metadata and cached analysis (silence, scenes, transcript, EBU R128 loudness)")]
    ...
    #[tool(description = "Analyze an asset (silence + scene detection, EBU R128 loudness, and transcription when configured) and cache the result")]
